...
recomendados, y mientras la API de recomendaciones no exista SHALL presentar ese destino
como pendiente sin declarar resultados ni simular datos.
...
- **THEN** el frontend navega al destino de candidatos de ese puesto

#### Scenario: Recomendaciones todavía no disponibles
- **WHEN** el empleador abre el destino de candidatos recomendados
- **THEN** el frontend explica que las recomendaciones se calculan de forma diferida,
  no muestra candidatos inventados y ofrece regresar al listado
